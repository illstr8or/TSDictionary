...
class VocabulariesControllerTest < ActionController::TestCase
  ...
  test "should create vocabulary" do
    assert_difference('Vocabulary.count') do
      post :create, vocabulary: { definition: @vocabulary.definition, image: @vocabulary.image, pronunciation: @vocabulary.pronunciation, translated: @vocabulary.translated, word: @vocabulary.word }
    end
  ...
  test "should update vocabulary" do
    patch :update, id: @vocabulary, vocabulary: { definition: @vocabulary.definition, image: @vocabulary.image, pronunciation: @vocabulary.pronunciation, translated: @vocabulary.translated, word: @vocabulary.word }
    assert_redirected_to vocabulary_path(assigns(:vocabulary))
  end
